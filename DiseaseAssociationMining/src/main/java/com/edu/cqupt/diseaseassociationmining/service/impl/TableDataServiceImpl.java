...
import com.edu.cqupt.diseaseassociationmining.mapper.*;
...
public class TableDataServiceImpl implements TableDataService {
    ...
    @Override
    public List<LinkedHashMap<String, Object>> getAllTableData(String tableName) {
        List<LinkedHashMap<String, Object>> tableData = tableDataMapper.getAllTableData(tableName);
        return tableData;
    }

    @Override
    public List<String> upload(MultipartFile file,String tableName) throws IOException{
    ...
    public List<String> uploadFile(MultipartFile file, String tableName, String type, String user, String userId, String parentId, String parentType,String status,Double size,String is_upload,String is_filter) throws IOException, ParseException {
        ...
        tableDescribeEntity.setTableSize(new Float(size.floatValue()));
        // 保存表描述信息
        tableDescribeMapper.insert(tableDescribeEntity);
        List<String> featureList = storeTableData(file, tableName);
        userMapper.decUpdateUserColumnById(Integer.parseInt(userId),size);
        return featureList;
    }
    ...
    public void createTable(String tableName, List<CreateTableFeatureVo> characterList, String createUser, CategoryEntity nodeData,String uid,String username,String IsFilter,String IsUpload) {
         ...
         *
         */
        List<LinkedHashMap<String, Object>> res = getFilterDataByConditions(characterList, nodeData,uid,username);
